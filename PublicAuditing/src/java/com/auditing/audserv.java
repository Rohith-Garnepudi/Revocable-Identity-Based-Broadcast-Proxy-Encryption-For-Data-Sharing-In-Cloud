...
public class audserv extends HttpServlet {
     ...
     */
     ...
     String password = "pwgespwxqoickyvf";
    String from = "shiva.jan061996@gmail.com";
...
//        final String UPLOAD_DIRECTORY = "G:/" + group;
//
        ...
        if (ServletFileUpload.isMultipartContent(request)) {
            try {
              ...
              String hashvalue=  mdhashing.shaa(TempUploadDirectory + File.separator + nn);
               ...
               session1.setAttribute("filename", nn); 
               ...
               while(rs.next())
{
    ...
    }else
    {
        ...
        session1.setAttribute("group", user);
        ...
        if(rss.next())
        {
            ...
            response.sendRedirect("Corrupted.jsp");
